...
Process.prototype.doSetPenFont = function (fnt) {
    if (!loadedFonts.indexOf("https://fonts.googleapis.com/css?family=" + encodeURIComponent(fnt.replaceAll(" ", "+")))) {
        loadedFonts.push("https://fonts.googleapis.com/css?family=" + encodeURIComponent(fnt.replaceAll(" ", "+")));
        var style = document.createElement("link");
        style.rel = "stylesheet";
        style.href = "https://fonts.googleapis.com/css?family=" + encodeURIComponent(fnt.replaceAll(" ", "+"));
