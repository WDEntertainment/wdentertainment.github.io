...
Process.prototype.setCursorIconTo = function (curStyle) {
    document.querySelector('body').style.cursor = curStyle;
}

Process.prototype.doAddGoogolFont = function(fontName) {
    ...
    window.loadedFonts.push(fontLink);
}

Process.prototype.setPenFontTo = function(fntName) {
    window.currentPenFont = fntName;
    window.currentPenFontThing = "sans-serif";
}
...
Process.prototype.reportUsername = function() {
    return world.children[0].cloud.username;
}
