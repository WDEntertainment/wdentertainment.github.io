...
SpriteMorph.prototype.initBlocks = function () {
    SpriteMorph.prototype.blocks = {
        ...
        // Looks - Debugging primitive for development mode
        reportCostumes: {
            dev: true,
            type: 'reporter',
            category: 'looks',
        ...
        doSetPenFont: {
            type: 'command',
            category: 'pen',
            spec: 'set pen font to %s'
        },
        write: {
            only: SpriteMorph,
            type: 'command',
            category: 'pen',
            spec: 'write %s size %n align %alignm',
            defaults: [localize('Hello!'), 12, 'left']
        },
...
SpriteMorph.prototype.blockTemplates = function (
    ...
    if (category === 'motion') {
        ...
        blocks.push(block('doSetPenFont'));
        blocks.push('-');
...
SpriteMorph.prototype.write = function (text, size, align) {
    ...
    context.save();
    context.font = size + 'px ' + penFont || "monospace";
