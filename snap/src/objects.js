...
SpriteMorph.prototype.initBlocks = function () {
    SpriteMorph.prototype.blocks = {
        ...
        setCursorIconTo: {
            type: 'command',
            category: 'sensing',
            spec: 'set cursor icon to %curmenu',
            defaults: [['pointer']]
        },
        doSetGlobalFlag: {
            type: 'command',
...
SpriteMorph.prototype.blockTemplates = function (
    ...
    if (category === 'motion') {
        ...
        blocks.push('-');
        blocks.push(block('doAddGoogolFont'));
        blocks.push(block('setPenFontTo'));
        ...
        blocks.push(block('setCursorIconTo'));
...
SpriteMorph.prototype.write = function (text, size) {
    ...
    context.save();
    if (window.currentPenFontThing == "monospace") {
        context.font = size + 'px' + ' monospace'
    } else {
        context.font = size + 'px ' + '"' + window.currentPenFont.toLowerCase() + '"';
    }
