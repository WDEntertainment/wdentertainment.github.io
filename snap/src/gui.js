...
IDE_Morph.prototype.settingsMenu = function () {
    ...
    addPreference(
        'Light Theme',
        'setTheme',
        MorphicPreferences.isLightThemed,
        'uncheck for dark\nGUI theme',
        'check for a light\nGUI theme',
        false
    )
...
IDE_Morph.prototype.saveXMLAs = function(xml, fileName) {
    ...
    this.saveFileAs(xml, 'text/xml;chartset=utf-8', fileName, ".proj");
};
...
IDE_Morph.prototype.setFlat = function() {
    if (MorphicPreferences.isFlat) {
        MorphicPreferences.isFlat = false;
        world.changed();
    } else {
...
IDE_Morph.prototype.setTheme = function() {
    var lstIsFlat = MorphicPreferences.isFlat;
    if (MorphicPreferences.isLightThemed) {
        MorphicPreferences.isLightThemed = false;
        this.setDefaultDesign();
        MorphicPreferences.isFlat = lstIsFlat;
        this.buildPanes();
        this.fixLayout();
        this.flushBlocksCache();
        this.refreshPalette();
        ...
        MorphicPreferences.isLightThemed = true;
        this.setFlatDesign();
        MorphicPreferences.isFlat = lstIsFlat;
        this.buildPanes();
        this.fixLayout();
