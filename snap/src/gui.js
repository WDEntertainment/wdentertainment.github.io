...
IDE_Morph.prototype.download = function (name, content) {
    saveAs(content, name);
}
...
IDE_Morph.prototype.darkMode = function () {
    this.setDarkMode();
    this.refreshIDE();
    this.removeSetting('mode');
};

IDE_Morph.prototype.lightMode = function () {
    this.setLightMode();
    this.refreshIDE();
    this.saveSetting('mode', 'light');
};
...
IDE_Morph.prototype.settingsMenu = function () {
    ...
    addPreference(
        'Flat Design',
        () => {
            if (MorphicPreferences.isFlat == true) {
                this.defaultDesign();
            } else {
                this.flatDesign();
            }
